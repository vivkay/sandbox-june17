...
// Insult generator //
var setup = ["You're nothing but a ", "Be gone! You ", "Villain, you ain't nothing but a ", "My dear, you ain't nothing but a ", "You poor, base, rascally ", "I scorn you! You nasty, ", "Peace, ye ", "No one likes a ", "U R A ", "Yer nothin' but a ", "YOU, my friend, are a good for nothing, ", "Yo mamma is a ", "ACK! Get back, you ", "Your face is like a ", "You're a ", "You remind me of a ", "That outfit makes you look like a ", "Be gone, you ", "You smell like a "];
var adjective = ["stewed ", "catastrophically hideous ", "filthy ", "mammering ", "yeasty ", "bootless ", "hell-hated ", "ticklish ", "septic ", "tart-faced ", "llama-faced ", "lecherous", "crooked-nosed ", "soggy ", "moist ", "mouldy ", "classless ", "second-rate ", "pigeon livered ", "pot bellied ", "shabby ", "torpid", "cheeky ", "gaumless ", "blooming ", "savage ", "flea-bitten ", "lousy ", "filthy ", "horrid ", "villaenous ", "slobbering ", "half-digested ", "vile ", "loony ", "poop filled ", "smelly ", "rotting ", "cantankerous ", "haggard ", "feather-brained ", "nubile ", "feckless ", "withering ", "dowdy ", "crapulous ", "pathetic ", "grossity-gross-gross old "];
var noun = ["prune", "ham sandwich", "shell of a person", "and squiggly worm", "hollow-brained sack of turds", "boil", "horn-beast", "apricot", "toenail", "pignut", "sack of diarrhea", "ghoul", "cream faced loon", "rooting hog", "toad", "elf-skin", "ratbag", "malmsey nose", "dodo", "plebian ", "goat", "blighter", "mound of belly flob", "strumpet", "gizzard", "trash pigeon", "fiend", "armpit", "bedswerver", "lump ", "nincompoop", "mumblecrust", "zombie testicle", "lubberwort", "loiter-sack", "raggabrash", "saddle-goose", "scobberlotcher", "whiffle-whaffle", "fopdoodle", "scullion", "rampallian", "strumpet", "lubberwort", "carbuncle", "grumbletonian", "ding-dong", "elbow", "curtain rod", "walnut", "boob", "pile of wrinkles", "armpit", "knave", "jigglypuff"];
...
document.querySelector('.insult-btn').onclick = () =>
